    ...
    <header className="sticky top-0 z-40 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="flex h-14 items-center justify-between px-3 sm:px-6">
        <div className="flex items-center gap-1">
          ...
          <Link
            href={ROUTES.HOME}
            className="hidden items-center gap-2 px-2 font-bold tracking-tight md:flex"
          >
            <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br from-gold to-amber-500 text-sm font-black text-ink-900">
              M
            </span>
            <span>MyselfX AI</span>
          </Link>
        </div>
